...
### Linux/macOS
```sh
bash <(curl -Ls https://raw.githubusercontent.com/bluefair13/s-ui-from-alireza0/master/install.sh)
```
...
### Linux/macOS
1. Get the latest version of S-UI based on your OS/Architecture from GitHub: [https://github.com/bluefair13/s-ui-from-alireza0/releases/latest](https://github.com/alireza0/s-ui/releases/latest)
2. **OPTIONAL** Get the latest version of `s-ui.sh` [https://raw.githubusercontent.com/bluefair13/s-ui-from-alireza0/master/s-ui.sh](https://raw.githubusercontent.com/alireza0/s-ui/master/s-ui.sh)
...
### Windows
1. Get the latest Windows version from GitHub: [https://github.com/bluefair13/s-ui-from-alireza0/releases/latest](https://github.com/alireza0/s-ui/releases/latest)
